"""
手元の CV スコアと public LB のスコアを用いて、seenとunseenの割合を推定するスクリプト
"""
...
scores = [
    ...
    [1.0954085658317116, 1.358500644820181, 1.1762],
    [1.116778494624178, 1.355808659344834, 1.1776],
    [1.0912852641752468, 1.3553797871516866, 1.1741],
    [1.090605638721303, 1.3553797871516866, 1.1740],
    [1.0902675949752783, 1.3553797871516866, 1.1739],
]
